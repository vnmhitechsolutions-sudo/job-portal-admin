...
const EmployeeAdminPanel = () => {
  ...
  return (
    <Box p={3}>
      ...
      <Box height="70vh">
        <DataGrid rows={employees} columns={columns} loading={loading} pageSize={10} disableRowSelectionOnClick sx={{ "& .MuiDataGrid-cell": { outline: "none" }, "& .MuiDataGrid-columnHeaders": { fontWeight: 600 } }} />
      </Box>
