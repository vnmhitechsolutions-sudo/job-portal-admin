...
const Reports = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const applications = Array.isArray(applicationsRes.data || applicationsRes)
        ? (applicationsRes.data || applicationsRes)
        : [];

      const profilesRaw = profilesRes.data || profilesRes;
